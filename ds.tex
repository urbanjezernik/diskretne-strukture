...
\begin{figure}[h]
    \centering
    \includegraphics{img/opis-petersen.png}
...
V ta namen moramo dokazati, da za \emph{vsako} interpretacijo $I$ velja $I \models \phi$. Naj bo torej $I$ poljubna interpretacija. V tej interpretaciji moramo torej dokazati, da je izjava $\bar \phi$ veljavna, kar je enakovredno veljavnosti sklepa $\models \bar \phi$, se pravi veljavnosti sklepa
\[
    \models 
...
\begin{zgled} \leavevmode
    \begin{itemize}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics{img/relacije-graf.png}
        ...
        \begin{itemize}
            ...
            \item $R = \{ (x,x) \mid x \in A \} \subseteq A \times A$. To je {\definicija relacija enakosti}. Zanjo uporabljamo oznako $id_A$. V tej relaciji je vsak element množice $A$ v relaciji le s sabo.
        \end{itemize}
    \end{itemize}
\end{zgled}
...
Naj bo $R \subseteq A \times A$ ekvivalenčna relacija. Tedaj velja:
\begin{enumerate}
    \item Za vsak $x \in A$ je $R[x] \neq \emptyset$.
    \item Za vsaka $x,y \in A$ velja implikacija $R[x] \neq R[y] \Rightarrow R[x] \cap R[y] = \emptyset$,
...
\begin{itemize}
    ...
    \item Množico $\ZZ$ lahko definiramo kot kvocientno množico množice $A = \NN_0 \times \NN_0$ po relaciji $R$, kjer je $(a,b)R(c,d)$, če in samo če $a+d = b+c$. Velja
    \[
...
\begin{description}
    ...
    \item[indukcijski korak:] $\forall n \in \NN_0 \colon R^{n+1} = R^n \circ R$.
\end{description}
...
\begin{itemize}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/relacije-hasse.png}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/relacije-hasse-mnozice.png}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/relacije-hasse-linearna.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-prvizgled.png}
...
\begin{zgled}
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-multigraf.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-std-izolirana.png}
...
\begin{itemize}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-2reg.png}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-3reg.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-std.png}
    \caption{Lizika}
\end{figure}
...
\begin{zgled} \leavevmode
    \begin{itemize}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics{img/grafi-zanimiv-zgled.png}
            \caption{Graf $G_1$}
        \end{figure}

        \begin{figure}[h]
            \centering
            \includegraphics{img/grafi-primerjava.png}
            \caption{Graf $G_2$}
        \end{figure}
...
\begin{zgled}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-pot-cikel.png}
...
\begin{zgled}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-razdalja.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-drevo.png}
    \caption{Drevo}
\end{figure}    
\end{zgled}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/konigsberg.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-konigsberg.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/ljubljana.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-enapoteza.png}
...
\begin{zgled}
    ...
    \begin{itemize}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics{img/grafi-hamilton.png}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics{img/grafi-hamilton-zgled.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-hamilton-zgled-dvodelen.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-hamilton-zgled-pot.png}
...
\begin{zgled}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-hamilton-ore.png}
...
\begin{zgled}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-hamilton-dirac.png}
...
\begin{zgled}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-petersen-hamilton-pot.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-konjicek-graf.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/grafi-konjicek.png}
...
\begin{zgled}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics{img/grafi-ravninski-k4.png}
...
Privzemimo zdaj, da formula velja za vse grafe z največ $c$ cikli. Naj bo $G$ graf s $c+1$ cikli. Naj bo $C$ nek cikel v $G$ z povezavo $\{ u,v \}$ na $C$. Opazujmo graf $G' = G - uv$. Naj bo $\GG'$ ravninska vložitev tega grafa, ki ga dobimo iz ravninske vložitve $\GG$. Graf $G'$ je povezan in ima manj ciklov kot $G$, zato lahko na njem uporabimo indukcijsko predpostavko. Za ta graf velja $|V(\GG')| = |V(G)|$ in $|E(\GG')| = |E(G)| - 1$, hkrati pa se z odstranitvijo povezave $uv$ lici s skupnim robom $uv$ spojita v eno lice, zato je $|F(\GG')| = |F(\GG)| - 1$. Ker po indukcijski predpostavki velja $|V(\GG')| - |E(\GG')| + |F(\GG')| = 2$, od tod sledi $|V(\GG)| - |E(\GG)| + |F(\GG)| = 2$. \kljuka
\end{dokaz}
...
\begin{figure}[h]
    \centering
    \includegraphics{img/obcine.png}
